...
\begin{abstract}
We present GDSFactory, an open-source Python library for integrated circuit design automation supporting photonics, analog, quantum, and MEMS applications. The platform provides unified workflows for full chip development: layout design, simulation (device and circuit via S-parameter analysis).
\end{abstract}
