...
\authormark{8}Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA}
...
Unlike constrained logic-driven electronic design flows~\cite{bogaerts2018}, integrated photonics requires freeform parametric geometries and tight integration between layout and electromagnetic simulation. GDSFactory addresses this with scriptable parametric cells (PCells), hierarchical assembly, directional ports, routing, and seamless interfaces to industry-standard simulators---all in Python's extensive scientific ecosystem~\cite{awesome} (Fig.~\ref{fig:flow}).
